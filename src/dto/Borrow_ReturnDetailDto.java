...
public class Borrow_ReturnDetailDto {
    String borrowId, bookId, borrowCondition, returnCondition, returnDate, finedReason;
    Double fines;
    
    public Borrow_ReturnDetailDto() {
    }

    public Borrow_ReturnDetailDto(String borrowId, String bookId, String borrowCondition, String returnCondition,
