...
public class AdminViewController implements Initializable {
    ...
    //------------LOGOUT FUNCTION----------------
    @FXML
    void btnLogoutOnAcction(ActionEvent event) throws IOException {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ObservableList<String> list = FXCollections.observableArrayList("Manage Users", "Manage Categories", 
                "Manage Books", "Manage Members", "Update Fines", "Issue Books", "Return Books");  //------------ADD ITEMS TO COMBO BOX----------------
    ...
    private void loadInterface(int index) throws IOException {
        String nextInterface = switch (index) {
            case 0 -> "ManageUser.fxml";
            case 1 -> "ManageCategories.fxml";
            case 2 -> "ManageBooks.fxml";
            case 3 -> "ManageMembers.fxml";
            case 4 -> "UpdateFines.fxml";
            case 5 -> "ManageBorrowing.fxml";
            case 6 -> "ManageReturn.fxml";
